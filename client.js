...
socket.on('welcome',(data)=>{
    data.forEach(pair => {
        //console.log(`Rider, Driver : ${pair.riderName} , ${pair.driverName}, car number ${pair.carNumber}. Total cost = ${pair.cost}`);
        console.log(` ${pair.riderName} is paired with ${pair.driverName}, Fare = ${pair.cost}`);
        giveRating(pair);
    });
